...
<html lang="en">
  ...
  <title>deploy-dash-with-gcp/__init__.py at master · datasciencecampus/deploy-dash-with-gcp</title>
    <meta name="description" content="A simple dash application that shows users how to deploy dash using Google Cloud Platform (GCP) - datasciencecampus/deploy-dash-with-gcp">
    <link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="GitHub">
  <link rel="fluid-icon" href="https://github.com/fluidicon.png" title="GitHub">
  <meta property="fb:app_id" content="1401488693436528">

    <meta name="twitter:image:src" content="https://avatars3.githubusercontent.com/u/25666867?s=400&amp;v=4" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary" /><meta name="twitter:title" content="datasciencecampus/deploy-dash-with-gcp" /><meta name="twitter:description" content="A simple dash application that shows users how to deploy dash using Google Cloud Platform (GCP) - datasciencecampus/deploy-dash-with-gcp" />
    <meta property="og:image" content="https://avatars3.githubusercontent.com/u/25666867?s=400&amp;v=4" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="datasciencecampus/deploy-dash-with-gcp" /><meta property="og:url" content="https://github.com/datasciencecampus/deploy-dash-with-gcp" /><meta property="og:description" content="A simple dash application that shows users how to deploy dash using Google Cloud Platform (GCP) - datasciencecampus/deploy-dash-with-gcp" />

  <link rel="assets" href="https://github.githubassets.com/">
    <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6NTI3MzA2NjI4OjQ2YzVmNzg5ZTYyNDFkMTU0MzFjNjM2ODEzYmE3ZGIyZGQ4OTY3MjEwNmMxMWI4MDEwNGFmMTlhZjM5MWIzNzc=--90c2b61c94181defbaf010967f1621bca35dcc0d">
  <link rel="sudo-modal" href="/sessions/sudo_modal">

  <meta name="request-id" content="8DFA:5F92:CEC3C8:1128DAD:5EDDB2C6" data-pjax-transient="true" /><meta name="html-safe-nonce" content="2bad8b6155853b26ede267c4bb464f8a9154aed6" data-pjax-transient="true" /><meta name="visitor-payload" content="" data-pjax-transient="true" /><meta name="visitor-hmac" content="f1a084029ac1f092cd555a6370f8f4c2559082558aa38699f6087185c338e785" data-pjax-transient="true" />
...
<meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-ga_id" content="" class="js-octo-ga-id" /><meta name="octolytics-actor-id" content="53094673" /><meta name="octolytics-actor-login" content="Manistrikes23493" /><meta name="octolytics-actor-hash" content="e590db2dbba5fa393d6330d493409e4b7f4ed8a212d1a9e8bc78d22914bbee01" />
...
<meta name="optimizely-sdk-key" content="cowimJNste4j7QnBNCjaw" />
  ...
  <meta class="js-ga-set" name="userId" content="99e7649301cbc3122e68a81fc3b0fbb6">
...
<meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="Manistrikes23493">


      <meta name="expected-hostname" content="github.com">

      <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta http-equiv="x-pjax-version" content="2427884fafeb5e02c2dfe9ab2f4f9f4c">
      ...
      <link href="https://github.com/datasciencecampus/deploy-dash-with-gcp/commits/master.atom" rel="alternate" title="Recent Commits to deploy-dash-with-gcp:master" type="application/atom+xml">

  <meta name="go-import" content="github.com/datasciencecampus/deploy-dash-with-gcp git https://github.com/datasciencecampus/deploy-dash-with-gcp.git">

  <meta name="octolytics-dimension-user_id" content="25666867" /><meta name="octolytics-dimension-user_login" content="datasciencecampus" /><meta name="octolytics-dimension-repository_id" content="235317360" /><meta name="octolytics-dimension-repository_nwo" content="datasciencecampus/deploy-dash-with-gcp" /><meta name="octolytics-dimension-repository_public" content="true" /><meta name="octolytics-dimension-repository_is_fork" content="false" /><meta name="octolytics-dimension-repository_network_root_id" content="235317360" /><meta name="octolytics-dimension-repository_network_root_nwo" content="datasciencecampus/deploy-dash-with-gcp" /><meta name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" content="false" />


    <link rel="canonical" href="https://github.com/datasciencecampus/deploy-dash-with-gcp/blob/master/app/__init__.py" data-pjax-transient>
...
>
  <div class="position-relative">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" role="search" aria-label="Site" data-scope-type="Repository" data-scope-id="235317360" data-scoped-search-url="/datasciencecampus/deploy-dash-with-gcp/search" data-unscoped-search-url="/search" action="/datasciencecampus/deploy-dash-with-gcp/search" accept-charset="UTF-8" method="get">
      <label class="form-control input-sm header-search-wrapper p-0 header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          autocomplete="off"
          >
          <input type="hidden" value="iJg6qEGcdJhQMRoyZLml809vpomJvXdCIi0vYeH6x07vNy6BpG0/xKItfzRZvQXD2CTedZAtTKJbx3truByEVw==" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" />
...
<li class="d-flex flex-justify-start flex-items-center p-0 f5 navigation-item js-navigation-item js-jump-to-global-search d-none" role="option">
  ...
  <a class="js-selected-navigation-item Header-link py-lg-3  mr-0 mr-lg-3 py-2 border-top border-lg-top-0 border-white-fade-15" data-ga-click="Header, click, Nav menu - item:explore" data-selected-links="/explore /trending /trending/developers /integrations /integrations/feature/code /integrations/feature/collaborate /integrations/feature/ship showcases showcases_search showcases_landing /explore" href="/explore">
    ...
    <a class="Header-link d-block d-lg-none mr-0 mr-lg-3 py-2 py-lg-3 border-top border-lg-top-0 border-white-fade-15" href="/Manistrikes23493">
      <img class="avatar avatar-user" src="https://avatars1.githubusercontent.com/u/53094673?s=40&amp;v=4" width="20" height="20" alt="@Manistrikes23493" />
      Manistrikes23493
</a>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/logout" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="Haei9KT1hiSKRtWqHrXkFx7rUtyNcoAZp0tkt3z1M2UJMFIsUpL+8UbNqHGZLB0NnhrJturyK3aZyfSOAlZf5g==" />
  ...
  <div class="Header-item Header-item--full flex-justify-center d-lg-none position-relative">
    ...
    <a class="Header-link" href="/datasciencecampus">datasciencecampus</a>
    /
    <a class="Header-link" href="/datasciencecampus/deploy-dash-with-gcp">deploy-dash-with-gcp</a>
  ...
  <div class="Header-item mr-0 mr-lg-3 flex-order-1 flex-lg-order-none">
    ...
    <a aria-label="You have no unread notifications" class="Header-link notification-indicator position-relative tooltipped tooltipped-sw js-socket-channel js-notification-indicator" data-hotkey="g n" data-ga-click="Header, go to notifications, icon:read" data-channel="notification-changed:53094673" href="/notifications">
...
<a role="menuitem" class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <div class="dropdown-header">
    <span title="datasciencecampus/deploy-dash-with-gcp">This repository</span>
  </div>
    <a role="menuitem" class="dropdown-item" href="/datasciencecampus/deploy-dash-with-gcp/issues/new/choose" data-ga-click="Header, create new issue" data-skip-pjax>
      New issue
    </a>
  ...
  <details class="details-overlay details-reset js-feature-preview-indicator-container" data-feature-preview-indicator-src="/users/Manistrikes23493/feature_preview/indicator_check">

  <summary class="Header-link"
    aria-label="View profile and more"
    data-ga-click="Header, show menu, icon:avatar">
    <img
  alt="@Manistrikes23493"
  width="20"
  height="20"
  src="https://avatars2.githubusercontent.com/u/53094673?s=60&amp;v=4"
  ...
  <details-menu class="dropdown-menu dropdown-menu-sw mt-n2" style="width: 180px">
    <div class="header-nav-current-user css-truncate"><a role="menuitem" class="no-underline user-profile-link px-3 pt-2 pb-2 mb-n2 mt-n1 d-block" href="/Manistrikes23493" data-ga-click="Header, go to profile, text:Signed in as">Signed in as <strong class="css-truncate-target">Manistrikes23493</strong></a></div>
    <div role="none" class="dropdown-divider"></div>
...
<div class="js-user-status-container
  ...
  <details class="js-user-status-details details-reset details-overlay details-overlay-dark">
    <summary class="btn-link btn-block link-gray no-underline js-toggle-user-status-edit toggle-user-status-edit "
      role="menuitem" data-hydro-click="{&quot;event_type&quot;:&quot;user_profile.click&quot;,&quot;payload&quot;:{&quot;profile_user_id&quot;:25666867,&quot;target&quot;:&quot;EDIT_USER_STATUS&quot;,&quot;user_id&quot;:53094673,&quot;originating_url&quot;:&quot;https://github.com/datasciencecampus/deploy-dash-with-gcp/blob/master/app/__init__.py&quot;}}" data-hydro-click-hmac="0de44dd3471321a66a9402b84257f2db2ba98684dfe67d236fed30515a5eea14">
      <div class="d-flex">
...
"
    ...
    <details-dialog class="details-dialog rounded-1 anim-fade-in fast Box Box--overlay" role="dialog" tabindex="-1">
      <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="position-relative flex-auto js-user-status-form" action="/users/status?compact=1&amp;link_mentions=0&amp;truncate=1" accept-charset="UTF-8" method="post"><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="xZtdp0FnPJDi4shNalOv7bMoYh9yV2Zr+Sx3ib+ysbE2VMHNMmSsv+59M2ieYnN+ANKTPEI610FOswqfKIebkQ==" />
  ...
  <details class="js-user-status-expire-drop-down f6 dropdown details-reset details-overlay d-inline-block mr-2">
    ...
    <ul class="dropdown-menu dropdown-menu-se pl-0 overflow-auto" style="width: 220px; max-height: 15.5em">
      ...
      <li class="dropdown-divider" role="none"></li>
        <li>
          <button type="button" class="btn-link dropdown-item ws-normal js-user-status-expire-button" title="in 30 minutes" value="2020-06-08T09:38:50+05:30">
            in 30 minutes
          </button>
        </li>
        <li>
          <button type="button" class="btn-link dropdown-item ws-normal js-user-status-expire-button" title="in 1 hour" value="2020-06-08T10:08:50+05:30">
            in 1 hour
          </button>
        </li>
        <li>
          <button type="button" class="btn-link dropdown-item ws-normal js-user-status-expire-button" title="in 4 hours" value="2020-06-08T13:08:50+05:30">
            in 4 hours
          </button>
        </li>
        <li>
  ...
  <input class="js-user-status-expiration-date-input" type="hidden" name="expires_at" value="">
    ...
    <a role="menuitem" class="dropdown-item" href="/Manistrikes23493" data-ga-click="Header, go to profile, text:your profile">Your profile</a>

    <a role="menuitem" class="dropdown-item" href="/Manistrikes23493?tab=repositories" data-ga-click="Header, go to repositories, text:your repositories">Your repositories</a>


    <a role="menuitem" class="dropdown-item" href="/Manistrikes23493?tab=projects" data-ga-click="Header, go to projects, text:your projects">Your projects</a>

    <a role="menuitem" class="dropdown-item" href="/Manistrikes23493?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">Your stars</a>
...
<div id="feature-enrollment-toggle" class="hide-sm hide-md feature-preview-details position-relative">
  <button
    ...
    role="menuitem"
    data-feature-preview-trigger-url="/users/Manistrikes23493/feature_previews"
    data-feature-preview-close-details="{&quot;event_type&quot;:&quot;feature_preview.clicks.close_modal&quot;,&quot;payload&quot;:{&quot;originating_url&quot;:&quot;https://github.com/datasciencecampus/deploy-dash-with-gcp/blob/master/app/__init__.py&quot;,&quot;user_id&quot;:53094673}}"
    data-feature-preview-close-hmac="26770ddc2bb925152c859f7980a9ea6ad9b0604501f8579601b09ddc3088ac3c"
    data-hydro-click="{&quot;event_type&quot;:&quot;feature_preview.clicks.open_modal&quot;,&quot;payload&quot;:{&quot;link_location&quot;:&quot;user_dropdown&quot;,&quot;originating_url&quot;:&quot;https://github.com/datasciencecampus/deploy-dash-with-gcp/blob/master/app/__init__.py&quot;,&quot;user_id&quot;:53094673}}"
    data-hydro-click-hmac="478fd4d68a9b67ec264e2cd6cb1dd9aecb3985f4db1e79075632d6254a9adfcc"
  >
    Feature preview
  </button>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="logout-form" action="/logout" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="5sfXvGRHluOCgJlwIsiFnj+SDcysbCofKLQ+gSlxe7PyUCdkkiDuNk4L5KulUXyEv2OWpsvsgXAWNq64V9IXMA==" />
      
      <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout" role="menuitem">
        Sign out
      </button>
      <input type="text" name="required_field_f594" hidden="hidden" class="form-control" /><input type="hidden" name="timestamp" value="1591587530588" class="form-control" /><input type="hidden" name="timestamp_secret" value="50a8bbab300fb859f7bba1dd372938dd205e437221ad84bb346922ff974cd640" class="form-control" />
</form>  </details-menu>
</details>
  ...
  <div class="width-full container">
    <div class="width-full mx-auto shelf-content">
      ...
      <a class="btn btn-primary shelf-cta" target="_blank" data-hydro-click="{&quot;event_type&quot;:&quot;repository.click&quot;,&quot;payload&quot;:{&quot;target&quot;:&quot;READ_GUIDE&quot;,&quot;repository_id&quot;:235317360,&quot;originating_url&quot;:&quot;https://github.com/datasciencecampus/deploy-dash-with-gcp/blob/master/app/__init__.py&quot;,&quot;user_id&quot;:53094673}}" data-hydro-click-hmac="25fe172ba491f1745c52a3441496df2284b601ac4ea0559504227aac67fecc2a" href="https://guides.github.com/activities/hello-world/">Read the guide</a>
    </div>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="shelf-dismiss js-notice-dismiss" action="/dashboard/dismiss_bootcamp" accept-charset="UTF-8" method="post"><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="uQTWBqModUMDHyg6JeFnXkqKiPdwD6H+Yut+DUHgcZ2Qd/F+aQz7+/vPlAyRIhwEMUKyOWrUq9eM0jzi29Ze1g==" />
      <button name="button" type="submit" class="mr-1 close-button tooltipped tooltipped-w" aria-label="Hide this notice forever" data-hydro-click="{&quot;event_type&quot;:&quot;repository.click&quot;,&quot;payload&quot;:{&quot;target&quot;:&quot;DISMISS_BANNER&quot;,&quot;repository_id&quot;:235317360,&quot;originating_url&quot;:&quot;https://github.com/datasciencecampus/deploy-dash-with-gcp/blob/master/app/__init__.py&quot;,&quot;user_id&quot;:53094673}}" data-hydro-click-hmac="9d1900fd8f83b9215eb3be1f2da6768dbbcd15782655493e0a5a389229fee250">
  ...
  <span class="author ml-2 flex-self-stretch" itemprop="author">
    <a class="url fn" rel="author" data-hovercard-type="organization" data-hovercard-url="/orgs/datasciencecampus/hovercard" href="/datasciencecampus">datasciencecampus</a>
  </span>
  <span class="path-divider flex-self-stretch">/</span>
  <strong itemprop="name" class="mr-2 flex-self-stretch">
    <a data-pjax="#js-repo-pjax-container" href="/datasciencecampus/deploy-dash-with-gcp">deploy-dash-with-gcp</a>
  </strong>
    ...
    <li hidden>
      <include-fragment src="/datasciencecampus/deploy-dash-with-gcp/used_by_count" accept="text/fragment+html">
</include-fragment>
    </li>

  <li>
    
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-remote="true" class="clearfix js-social-form js-social-container" action="/notifications/subscribe" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="+3Y7zXkSdAYZZjQrUTGEzeuCY/j61x5RMudX7hIHn+Sdh1AFTlt9g/q+tLov+ja94c4YszTANA79fZS2BMkPsA==" />      <input type="hidden" name="repository_id" value="235317360">

      <details class="details-reset details-overlay select-menu float-left" >
        <summary class="select-menu-button float-left btn btn-sm btn-with-count" data-hydro-click="{&quot;event_type&quot;:&quot;repository.click&quot;,&quot;payload&quot;:{&quot;target&quot;:&quot;WATCH_BUTTON&quot;,&quot;repository_id&quot;:235317360,&quot;originating_url&quot;:&quot;https://github.com/datasciencecampus/deploy-dash-with-gcp/blob/master/app/__init__.py&quot;,&quot;user_id&quot;:53094673}}" data-hydro-click-hmac="7c5ed03773cc50c336b542c5d2de03bd0ec4d628da21c248edca3cb9a45c88e1" data-ga-click="Repository, click Watch settings, action:blob#show">          <span data-menu-button>
        ...
        <a class="social-count js-social-count"
          href="/datasciencecampus/deploy-dash-with-gcp/watchers"
  ...
  <ul class="list-style-none">
    <li  itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
      <a class="js-selected-navigation-item selected reponav-item" itemprop="url" data-hotkey="g c" aria-current="page" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches repo_packages repo_deployments /datasciencecampus/deploy-dash-with-gcp" href="/datasciencecampus/deploy-dash-with-gcp">
      ...
      <li  itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
        <a itemprop="url" data-hotkey="g i" class="js-selected-navigation-item reponav-item" data-selected-links="repo_issues repo_labels repo_milestones /datasciencecampus/deploy-dash-with-gcp/issues" href="/datasciencecampus/deploy-dash-with-gcp/issues">
    ...
    <li  itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
      <a data-hotkey="g p" data-skip-pjax="true" itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="repo_pulls checks /datasciencecampus/deploy-dash-with-gcp/pulls" href="/datasciencecampus/deploy-dash-with-gcp/pulls">
      ...
      <li itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement" class="position-relative float-left ">
        <a data-hotkey="g w" data-skip-pjax="true" class="js-selected-navigation-item reponav-item" data-selected-links="repo_actions /datasciencecampus/deploy-dash-with-gcp/actions" href="/datasciencecampus/deploy-dash-with-gcp/actions">
      ...
      <li >
        <a data-hotkey="g b" class="js-selected-navigation-item reponav-item" data-selected-links="repo_projects new_repo_project repo_project /datasciencecampus/deploy-dash-with-gcp/projects" href="/datasciencecampus/deploy-dash-with-gcp/projects">
      ...
      <li >
        <a class="js-selected-navigation-item reponav-item" data-hotkey="g w" data-selected-links="repo_wiki /datasciencecampus/deploy-dash-with-gcp/wiki" href="/datasciencecampus/deploy-dash-with-gcp/wiki">
      ...
      <li >
        <a data-skip-pjax="true" class="js-selected-navigation-item reponav-item" data-selected-links="security overview alerts policy token_scanning code_scanning /datasciencecampus/deploy-dash-with-gcp/security" href="/datasciencecampus/deploy-dash-with-gcp/security">
          ...
          Security
              <span class="Counter js-security-tab-count" data-url="/datasciencecampus/deploy-dash-with-gcp/security/overall-count" hidden></span>
</a>      </li>

      <li >
        <a class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph dependabot_updates pulse people /datasciencecampus/deploy-dash-with-gcp/pulse" href="/datasciencecampus/deploy-dash-with-gcp/pulse">
  ...
  <nav class="reponav js-reponav text-center no-wrap"
    ...
    <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
      <a class="js-selected-navigation-item selected reponav-item" itemprop="url" aria-current="page" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches repo_packages repo_deployments /datasciencecampus/deploy-dash-with-gcp" href="/datasciencecampus/deploy-dash-with-gcp">
        <span itemprop="name">Code</span>
        <meta itemprop="position" content="1">
</a>    </span>

      <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
        <a itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="repo_issues repo_labels repo_milestones /datasciencecampus/deploy-dash-with-gcp/issues" href="/datasciencecampus/deploy-dash-with-gcp/issues">
          <span itemprop="name">Issues</span>
          <span class="Counter">0</span>
          <meta itemprop="position" content="2">
</a>      </span>
    ...
    <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
      <a itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="repo_pulls checks /datasciencecampus/deploy-dash-with-gcp/pulls" href="/datasciencecampus/deploy-dash-with-gcp/pulls">
        <span itemprop="name">Pull requests</span>
        <span class="Counter">1</span>
        <meta itemprop="position" content="4">
</a>    </span>
      ...
      <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
        <a itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="repo_projects new_repo_project repo_project /datasciencecampus/deploy-dash-with-gcp/projects" href="/datasciencecampus/deploy-dash-with-gcp/projects">
      ...
      <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
        <a itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="repo_actions /datasciencecampus/deploy-dash-with-gcp/actions" href="/datasciencecampus/deploy-dash-with-gcp/actions">
          <span itemprop="name">Actions</span>
          <meta itemprop="position" content="6">
</a>      </span>

      <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
        <a itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="repo_wiki /datasciencecampus/deploy-dash-with-gcp/wiki" href="/datasciencecampus/deploy-dash-with-gcp/wiki">
          <span itemprop="name">Wiki</span>
          <meta itemprop="position" content="7">
</a>      </span>

      <a itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="security overview alerts policy token_scanning code_scanning /datasciencecampus/deploy-dash-with-gcp/security" href="/datasciencecampus/deploy-dash-with-gcp/security">
        <span itemprop="name">Security</span>
            <span class="Counter js-security-deferred-tab-count" hidden></span>
        <meta itemprop="position" content="8">
</a>
      <a class="js-selected-navigation-item reponav-item" data-selected-links="pulse /datasciencecampus/deploy-dash-with-gcp/pulse" href="/datasciencecampus/deploy-dash-with-gcp/pulse">
        Pulse
</a>
      <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
        <a itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="community /datasciencecampus/deploy-dash-with-gcp/community" href="/datasciencecampus/deploy-dash-with-gcp/community">
          Community
</a>      </span>
...
<div class="container-lg clearfix new-discussion-timeline  p-responsive">
  <div class="repository-content ">
    ...
    <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/datasciencecampus/deploy-dash-with-gcp/blob/eea72bf55e3a574f869bfa6c0e67a4a76d1bdfa7/app/__init__.py">Permalink</a>

    <!-- blob contrib key: blob_contributors:v22:b0cf31676e01f8ee3483ef2f1c689dac -->
...
<details class="details-reset details-overlay branch-select-menu " id="branch-select-menu">
  ...
  <details-menu class="SelectMenu SelectMenu--hasFilter" src="/datasciencecampus/deploy-dash-with-gcp/refs/master/app/__init__.py?source_action=show&amp;source_controller=blob" preload>
    <div class="SelectMenu-modal">
      <include-fragment class="SelectMenu-loading" aria-label="Menu is loading">
        ...
        <div class="BtnGroup flex-shrink-0 d-md-none">
          <a href="/datasciencecampus/deploy-dash-with-gcp/find/master"
                class="js-pjax-capture-input btn btn-sm BtnGroup-item"
                data-pjax
                data-hotkey="t">
            Find file
          </a>
          <clipboard-copy value="app/__init__.py" class="btn btn-sm BtnGroup-item">
            Copy path
          </clipboard-copy>
        </div>
      </span>
      <h2 id="blob-path" class="breadcrumb flex-auto min-width-0 text-normal flex-md-self-center ml-md-2 mr-md-3 my-2 my-md-0">
        <span class="js-repo-root text-bold"><span class="js-path-segment d-inline-block wb-break-all"><a data-pjax="true" href="/datasciencecampus/deploy-dash-with-gcp"><span>deploy-dash-with-gcp</span></a></span></span><span class="separator">/</span><span class="js-path-segment d-inline-block wb-break-all"><a data-pjax="true" href="/datasciencecampus/deploy-dash-with-gcp/tree/master/app"><span>app</span></a></span><span class="separator">/</span><strong class="final-path">__init__.py</strong>
      </h2>
    ...
    <include-fragment src="/datasciencecampus/deploy-dash-with-gcp/contributors/master/app/__init__.py" class="Box Box--condensed commit-loader">
...
<div class="Box-header py-2 d-flex flex-column flex-shrink-0 flex-md-row flex-md-items-center">
  ...
  <div class="d-flex py-1 py-md-0 flex-auto flex-order-1 flex-md-order-2 flex-sm-grow-0 flex-justify-between">
    ...
    <div class="BtnGroup">
      <a id="raw-url" class="btn btn-sm BtnGroup-item" href="/datasciencecampus/deploy-dash-with-gcp/raw/master/app/__init__.py">Raw</a>
        <a class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b" href="/datasciencecampus/deploy-dash-with-gcp/blame/master/app/__init__.py">Blame</a>
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/datasciencecampus/deploy-dash-with-gcp/commits/master/app/__init__.py">History</a>
    </div>
    ...
    <div>
          ...
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form js-update-url-with-hash" action="/datasciencecampus/deploy-dash-with-gcp/edit/master/app/__init__.py" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="OUFQafWDPiclaE8p0im3XCN9K/IUuQnn8YHjD/63MNsaeOLp9/O3N7avsWdzEJH2+6YQFoKWCsUyHv1p7cWbkQ==" />
          ...
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form" action="/datasciencecampus/deploy-dash-with-gcp/delete/master/app/__init__.py" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="Z50y/YdQEj1OVq6fEhXUK+dk9DvK9WlgwbGr6CFBQb9VwAWedC68Gdo2UN0BqlihCer4WWovthDnmZxSNkPTIg==" />
  ...
  <path d="M14.5 9C15.3284 9 16 8.32843 16 7.5C16 6.67157 15.3284 6 14.5 6C13.6716 6 13 6.67157 13 7.5C13 8.32843 13.6716 9 14.5 9Z"></path></svg>
    ...
    <details-menu>
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2" style="width:185px">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" role="menuitem" href="/datasciencecampus/deploy-dash-with-gcp/blame/eea72bf55e3a574f869bfa6c0e67a4a76d1bdfa7/app/__init__.py">View git blame</a></li>
          <li><a class="dropdown-item" id="js-new-issue" role="menuitem" href="/datasciencecampus/deploy-dash-with-gcp/issues/new">Reference in new issue</a></li>
      </ul>
    </details-menu>
  </details>
